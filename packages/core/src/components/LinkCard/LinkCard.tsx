...
export const LinkCardTitle = asSlot(
  LINK_CARD_DISPLAY_NAME.Title,
  forwardRef<HTMLDivElement, LinkCardTitleProps>(function LinkCardTitle(
...
export const LinkCardBody = asSlot(
  LINK_CARD_DISPLAY_NAME.Body,
  forwardRef<HTMLDivElement, LinkCardBodyProps>(function LinkCardBody(
    { className, children, ...rest },
    ref,
  ) {
    const classNames = useContext(LinkCardClassNamesContext);
